...
public class Block extends Node{
	...
	public Block(LinkedList<FieldDeclaration> f, LinkedList<Terminal> statements, LinkedList<Statement1> statements1, LinkedList<Statement3> statements3, LinkedList<Statement4> statements4, LinkedList<Statement5> statements5, LinkedList<Statement6> statements6){
	...
	public void print(String padding){
		...
		int f = this.fields.size(), s = this.statements.size(), s1 = this.statements1.size(), s3 = this.statements3.size(), s4 = this.statements4.size(), s5 = this.statements5.size(), s6 = this.statements6.size();
		for(int i = 0; i < f; i++)
